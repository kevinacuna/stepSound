          ...
          <div className="row h-100 align-items-center justify-content-center text-center animated fadeIn slow">
            <div className="col-lg-12 align-self-end">
              <h1
                ...
                className="text-uppercase blue-grey-text text-darken-4 font-weight-bold"
              >
                Step Sound
              </h1>
            ...
            <div className="row h-100 align-items-center justify-content-center">
              <div className="col-lg-12 align-self-end">
                <p className="font-weight-light blue-grey-text text-center text-darken-3 mt-4">
                  La historia comienza cuando el abuelo recuerda que tenía que
                  dejar un libro a su nieto.
                  <br />
                  Resulta que en ese libro había una foto donde aparece el
                  abuelo en un misterioso lugar cuando era jóven, concretamente
                  su lugar favorito.
                </p>
                <p className="font-weight-light blue-grey-text text-center text-darken-3 mt-4">
                  A modo de sorpresa, el nieto pone en marcha una aventura para
                  encontrar el lugar y poder fotografiarse allí, como un día lo
                  hizo su abuelo.
                  <br />
                  Desde el momento que emprende la búsqueda lo hace acompañado
                  de sus cascos...
                </p>
              </div>
